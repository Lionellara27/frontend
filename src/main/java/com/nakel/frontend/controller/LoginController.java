...
import com.nakel.frontend.util.SesionActual; // 🔥 IMPORTANTE: Importamos la sesión global
...
public class LoginController {
    ...
    public void onIngresarClick() {
        ...
        // 🔥 Validamos contra la API del Backend
        boolean loginExitoso = usuarioApiService.login(usuario, password);

        if (loginExitoso) {
            try {
                // 🔥 EL ESLABÓN PERDIDO: Guardamos el usuario que se acaba de loguear
                SesionActual.setUsuarioLogueado(usuario);
